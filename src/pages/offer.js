...
function Blank() {
  ...
  const [title, setTitle] = useState("Mes Participations");
              ...
              {/* <div className="col-xl-12">
                <div>
                  <button
                    ...
                    type="button"
                    className={`${
                      current == "OFFER" && "bg-yellow-500 text-white "
                    } focus:bg-yellow-500 focus:text-white text-yellow-400 hover:text-white  border-1 border-yellow-400 hover:bg-yellow-500  font-medium rounded-lg text-sm px-3 py-2.5 text-center mr-2 mb-2 `}
                  >
                    Mission
                  </button>
                  <button
                    ...
                    type="button"
                    className={`${
                      current == "COMMAND" && "bg-yellow-500 text-white "
                    } focus:bg-yellow-500 focus:text-white text-yellow-400 hover:text-white  border-1 border-yellow-400 hover:bg-yellow-500  font-medium rounded-lg text-sm px-3 py-2.5 text-center mr-2 mb-2 `}
                  >
                    Commande
                  </button>
